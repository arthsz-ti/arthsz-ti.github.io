...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.project-card, .timeline-item, .contact-item, .skill-category');
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        showNotification('Email preparado! Seu cliente de email será aberto.', 'success');
...
// Adicionar classe active ao CSS para links ativos
...
// Melhorar performance removendo listeners desnecessários
let ticking = false;

function updateOnScroll() {
    // Todas as funções relacionadas ao scroll aqui
    ticking = false;
}
